  ...
  <div class="privacy">
    <div class="page-content">
      <BaseTextblock>
        ...
        <p>
          Schützengilde „Hubertus“ Pfraundorf e. V.<br>
          Schützenmeister Thomas Berger<br>
          Eschenweg 1a<br>
          83064 Raubling<br>
          Germany<br>
        </p>
        ...
        <h3>Kontakt:</h3>
        <p>
          <a href="mailto:vorstand@hubertus-pfraundorf.de">vorstand@hubertus-pfraundorf.de</a>
        </p>
